...
parser.add_argument(
    "--start-goal-pos",
    type=list,
    default=[8.0, -2.0, -0.376, 0.0, 270.0, 0.0, -3.86, -2.3, -4.15],
    metavar="N",
    help="during testing, what are the initial positions, orientations for the"
...
# start_goal_pos = [15.0, -2.5, -15, 0.0, 270.0, 0.0, 5, -1.5, -5]  # test0
# start_goal_pos = [14, -3.42, 0.0, 0.0, 0.0, 0.0, -6.67, -1.97, -3.45]  # test3
# start_goal_pos = [8, -3.42, 2.76, 0., 270., 0., -7.67, -1.97, 1.45] # test5
# start_goal_pos = [10, -1.5, 0, 0., 270., 0., -10, -3.5, 0] # test6

start_goal_pos = [11.23, -3.42, -0.376, 0.0, 180.0, 0.0, -6.67, -1.97, -3.45]
